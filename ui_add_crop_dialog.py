...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(603, 474)
        self.frame = QFrame(Dialog)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(9, 9, 532, 391))
        ...
        self.frame_2.setGeometry(QRect(10, 10, 530, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_48.setText(QCoreApplication.translate("Dialog", u"Add New Crop Data", None))
        self.dateEdit.setAccessibleDescription(QCoreApplication.translate("Dialog", u"sadf", None))
        self.label_22.setText(QCoreApplication.translate("Dialog", u"City:", None))
        self.label_21.setText(QCoreApplication.translate("Dialog", u"Soil Type:", None))
        self.label_13.setText(QCoreApplication.translate("Dialog", u"Crop:", None))
        self.label_17.setText(QCoreApplication.translate("Dialog", u"Sowing Date:", None))
        self.add_crop_cnfrm.setText(QCoreApplication.translate("Dialog", u"Add crop", None))
        self.cancel_btn.setText(QCoreApplication.translate("Dialog", u"Cancel", None))
        self.title_label.setText(
            QCoreApplication.translate("Dialog", u"Agriculture Irrigation Desktop App | CARE IUB | Add New Crop", None))
